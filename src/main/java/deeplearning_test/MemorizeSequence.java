...
public class MemorizeSequence {
	...
	private static final char[] LEARNSTRING = "*The brown fox jumped over the lazy dog.".toCharArray();
	...
	public static void main(String[] args) {
		...
		net.init();
		net.setListeners(new CustomScoreIterationListener(1));
		...
		for (int epoch = 0; epoch < 1000; epoch++) {
            ...
            for (char ignored : LEARNSTRING) {
                ...
                string = string + LEARNSTRING_CHARS_LIST.get(sampledCharacterIdx);
            ...
            if(string.equals(temp)){
            	System.out.println("\n Completed with " + epoch + " iterations!");
            	break;
            } 
